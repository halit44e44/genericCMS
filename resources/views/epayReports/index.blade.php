    ...
    <div class="page-content">
        ...
        <div class="head-block">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">{{ __('epayReports.mainTitle') }}</div>
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered mb-0">
                        <thead>
                            <tr>
                                <th scope="col">{{ __('epayReports.startDate') }}</th>
                                <th scope="col">{{ __('epayReports.endDate') }}</th>
                                <th scope="col"></th>
                                <th scope="col"></th>
                                <th scope="col">
                                    <form action="">
                                        <input name="excel" id="excel" type="checkbox">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="date" id="datePickerEnd" name="datePickerEnd">
                                </td>
                                <td>
                                ...
                                <td><input type="submit" class="btn-order" value="{{ __('epayReports.reportBtn') }}"></input> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
